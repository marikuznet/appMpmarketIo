            ...
            <div class="d-flex justify-content-between">
              <div>
                ...
                <h2 class="mt-4 ff-secondary fw-semibold">
                  <count-to :duration="1000" :startVal="0" :endVal="547"></count-to>
                  k
                </h2>
          ...
          <div class="card-body">
            <div class="d-flex justify-content-between">
              <div>
                ...
                <h2 class="mt-4 ff-secondary fw-semibold">
                  <count-to :duration="1000" :startVal="0" :endVal="124"></count-to>
                  k
                </h2>
                <p class="mb-0 text-muted">
          ...
          <div class="card-body">
            <div class="d-flex justify-content-between">
              <div>
                ...
                <h2 class="mt-4 ff-secondary fw-semibold">
                  <count-to :duration="1000" :startVal="0" :endVal="107"></count-to>
                  K
                </h2>
                <p class="mb-0 text-muted">
                  <span class="badge bg-light text-danger mb-0">
        ...
        <div class="card" id="ticketsList">
          <div class="card-header border-0">
            <div class="d-flex align-items-center">
              <h5 class="card-title mb-0 flex-grow-1">{{ $t("t-tickets") }}</h5>
              <div class="flex-shrink-0">
                ...
                <button class="btn btn-danger add-btn" data-bs-toggle="modal" data-bs-target="#showModal"
                        @click="addnew">
                  <i class="ri-add-line align-bottom me-1"></i> {{ $t("t-create-tickets") }}
                </button>
              </div>
            </div>
          </div>
            ...
            <div class="table-responsive table-card mb-4">
              <table class="table align-middle table-nowrap mb-0" id="ticketTable">
                ...
                <tr>
                  ...
                  <th class="sort" data-sort="id">{{ $t("t-table-support-sort.id") }}</th>
                  <th class="sort" data-sort="tasks_name">{{ $t("t-table-support-sort.title") }}</th>
                  <th class="sort" data-sort="client_name">{{ $t("t-table-support-sort.client") }}</th>
                  <th class="sort" data-sort="assignedto">{{ $t("t-table-support-sort.assigned-to") }}</th>
                  <th class="sort" data-sort="create_date">{{ $t("t-table-support-sort.create-date") }}</th>
                  <th class="sort" data-sort="due_date">{{ $t("t-table-support-sort.due-date") }}</th>
                  <th class="sort" data-sort="status">{{ $t("t-table-support-sort.status") }}</th>
                  <th class="sort" data-sort="priority">{{ $t("t-table-support-sort.priority") }}</th>
                  <th class="sort" data-sort="action">{{ $t("t-table-support-sort.action") }}</th>
                </tr>
                </thead>
                  ...
                  <td>
                    <div class="dropdown">
                      ...
                      <ul class="dropdown-menu dropdown-menu-end">
                        <li>
                          <router-link class="dropdown-item" to="/apps/tickets-details"><i
                        ...
                        <li>
                          <a class="dropdown-item edit-item-btn" href="#showModal" data-bs-toggle="modal"
                             @click="editdata(data)">
                            <i class="ri-pencil-fill align-bottom me-2 text-muted"></i>  {{ $t("t-action.edit") }}
                          </a>
                        </li>
                        <li>
