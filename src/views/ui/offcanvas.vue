            ...
            <div class="col-lg-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <p class="text-muted">
                            Use the
                            <code>offcanvas</code> class to set a default offcanvas.
                        </p>
                                        ...
                                        <div class="acitivity-timeline p-4">
                                            <div class="acitivity-item d-flex">
                                                ...
                                                <div class="flex-grow-1 ms-3">
                                                    ...
                                                    >We talked about a project on linkedin.</p>
                                            ...
                                            <div class="acitivity-item py-3 d-flex">
                                                ...
                                                <div class="flex-grow-1 ms-3">
                                                    ...
                                                    <p class="text-muted mb-2">
                                                        ...
                                                        ></i> Create new project Buildng product
                                                    </p>
                                            ...
                                            <div class="acitivity-item py-3 d-flex">
                                                ...
                                                <div class="flex-grow-1 ms-3">
                                                    ...
                                                    <p
                                                        class="text-muted mb-2"
                                                    >Adding a new event with attachments</p>
                                                    <div
                                            ...
                                            <div class="acitivity-item py-3 d-flex">
                                                ...
                                                <div class="flex-grow-1 ms-3">
                                                    ...
                                                    <p
                                                        class="text-muted mb-2"
                                                    >added a new member to velzon dashboard</p>
                                            ...
                                            <div class="acitivity-item py-3 d-flex">
                                                ...
                                                <div class="flex-grow-1 ms-3">
                                                    ...
                                                    <p
                                                        class="text-muted mb-2"
                                                    >These customers can rest assured their order has been placed.</p>
                                            ...
                                            <div class="acitivity-item py-3 d-flex">
                                                ...
                                                <div class="flex-grow-1 ms-3">
                                                    ...
                                                    <p
                                                        class="text-muted mb-2"
                                                    >They all have something to say beyond the words on the page. They can come across as casual or neutral, exotic or graphic.</p>
                ...
                <div class="card">
                    <div class="card-header align-items-center d-flex">
                        ...
                        <div class="flex-shrink-0">
                            <div class="form-check form-switch form-switch-right form-switch-md">
                                <label
                                    for="placement-showcode"
                                    class="form-label text-muted"
                                >Show Code</label>
                                <input
                                    class="form-check-input code-switcher"
                                    type="checkbox"
                                    id="placement-showcode"
                                />
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card-body">
                        <p class="text-muted">
                            ...
                            <code>offcanvas-bottom</code>, or
                            <code>offcanvas-start</code> to offcanvas class to set different Offcanvas Placement.
                        </p>
                        <div class="live-preview">
                            ...
                            >
                                ...
                                <div class="offcanvas-body">
                                    <div class="row gallery-light">
                                                ...
                                                <div class="gallery-container">
                                                    <a href="#" title>
                                                        ...
                                                        <div class="gallery-overlay">
                                                            ...
                                                            >A mix of friends and strangers heading off to find an adventure.</h5>
                                                        </div>
                                                    </a>
                                                </div>
                                                ...
                                                <div class="gallery-container">
                                                    <a href="#" title>
                                                        ...
                                                        <div class="gallery-overlay">
                                                            <h5
                                                                class="overlay-caption"
                                                            >Dramatic clouds at the Golden Gate Bridge</h5>
                                                        </div>
                                                    </a>
                                                </div>
                                                <div class="box-content">
                                        ...
                                        <!--end col-->
                                        <div
                                            class="col-xl-3 col-lg-4 col-sm-6 d-md-none d-xl-block"
                                        >
                                            <div class="gallery-box card mb-0">
                                                <div class="gallery-container">
                                                    <a href="#" title>
                                                        ...
                                                        <div class="gallery-overlay">
                                                            <h5
                                                                class="overlay-caption"
                                                            >Fun day at the Hill Station</h5>
                                                        </div>
                                                    </a>
                                                </div>
                                                <div class="box-content">
                ...
                <div class="card">
                    <div class="card-header align-items-center d-flex">
                        ...
                        <div class="flex-shrink-0">
                            <div class="form-check form-switch form-switch-right form-switch-md">
                                <label
                                    for="backdrop-showcode"
                                    class="form-label text-muted"
                                >Show Code</label>
                                <input
                                    class="form-check-input code-switcher"
                                    type="checkbox"
                                    id="backdrop-showcode"
                                />
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card-body">
                        <p
                            class="text-muted"
                        >Here are the example of offcanvas with scrolling active and backdrop visible.</p>
                        <div class="live-preview">
                            <div class="d-flex flex-wrap gap-2">
                                <button
                                    class="btn btn-light"
