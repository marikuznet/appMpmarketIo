          ...
          <div class="card-body p-4">
            <div class="tab-content text-muted">
              <div class="tab-pane active" id="all" role="tabpanel">
                <div class="pb-3">
                  <h5 class="mb-1">
                    <a href="javascript:void(0);">Velzon - Responsive Bootstrap 5 Admin Dashboard</a>
                  </h5>
                ...
                <div class="py-3">
                  <h5 class="mb-1">
                    <a href="javascript:void(0);">Skote - Admin & Dashboard Template by Themesbrand</a>
                  </h5>
                  <p class="text-success mb-2">
                  ...
                  <div class="col-lg-12">
                    <div class="images-menu mb-3">
                      <swiper class="swiper responsive-swiper rounded gallery-light pb-4" :loop="true"
                        :slidesPerView="8" :spaceBetween="5">
                        <swiper-slide>
              ...
              <div class="tab-pane" id="video" role="tabpanel">
                <div class="row">
                  <div class="col-lg-12 video-list">
                    ...
                    <div class="list-element mt-4">
                      <h5 class="mb-1">
                        <a href="javascript:void(0);">Velzon - The Most Popular Bootstrap 5 HTML, Angular &
                          React Js Admin</a>
                      </h5>
                      <p class="text-success">
                        https://themesbrand.com/velzon/index.html
                    ...
                    <div class="list-element mt-4">
                      <h5 class="mb-1">
                        <a href="javascript:void(0);">Velzon Admin Dashboard (website analytics) with
                          Bootstrap 5</a>
                      </h5>
                      <p class="text-success">
                        https://themesbrand.com/velzon/index.html
