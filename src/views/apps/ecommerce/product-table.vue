      ...
      <div class="card">
        <div class="card-header">
          ...
          <div class="filter-choices-input">
            <Multiselect v-model="value" mode="tags" :close-on-select="true" :searchable="true" :create-option="true"
                         :options="[
                  { value: 'Скинни', label: 'Скинни' },
                  { value: 'Рубашки', label: 'Рубашки' },
                  { value: 'Sweatshirt', label: 'Sweatshirt' },
                  { value: '20%', label: '20%' },
                  { value: '4 звезды', label: '4 звезды' },
                ]"/>
          </div>
        </div>
        ...
        <div class="accordion accordion-flush">
            ...
            <div>
              ...
              <ul class="list-unstyled mb-0">
                ...
                <li>
                  ...
                  <div class="collapse" id="filterlist-fashion">
                    <ul class="ps-4">
                      <li>
            ...
            <div id="flush-collapseBrands" class="accordion-collapse collapse"
              ...
              <div class="accordion-body text-body pt-0">
                <div class="search-box search-box-sm">
                  <input type="text" class="form-control bg-light border-0" placeholder="Поиск бренда..."/>
          ...
          <div class="accordion-item">
            <h2 class="accordion-header" id="flush-headingColors">
              <button class="accordion-button bg-transparent shadow-none" type="button" data-bs-toggle="collapse"
                ...
                <span class="text-muted text-uppercase fs-12 fw-medium">Цвета</span>
                <span class="badge bg-success rounded-pill align-middle ms-1">2</span>
              </button>
            </h2>
          ...
          <div class="accordion-item">
            ...
            <div id="flush-collapseSize" class="accordion-collapse collapse"
