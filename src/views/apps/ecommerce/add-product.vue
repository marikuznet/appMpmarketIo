    ...
    <div class="row">
      <form>
        <div class="card">
          <div class="card-body">
            <div class="mb-3">
              <label class="form-label" for="product-title-input">{{ $t('t-table-products-sort.title') }}</label>
              <input type="text" class="form-control" id="product-title-input" placeholder="Enter product title"/>
            </div>
            <div class="mb-3">
              <label class="form-label" for="product-title-input">{{ $t('t-table-products-sort.brand') }}</label>
              <input type="text" class="form-control" id="product-title-input" placeholder="Enter product title"/>
            </div>
            <div class="mb-3">
              <label class="form-label" for="product-title-input">{{ $t('t-table-products-sort.item') }}</label>
              <input type="text" class="form-control" id="product-title-input" placeholder="Enter product title"/>
            </div>
            <div class="mb-3">
              <label class="form-label" for="product-title-input">{{ $t('t-table-products-sort.size-code') }}</label>
              <input type="text" class="form-control" id="product-title-input" placeholder="Enter product title"/>
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
              <label class="form-label" for="product-title-input">{{ $t('t-table-products-sort.wb-article') }}</label>
              <input type="text" class="form-control" id="product-title-input" placeholder="Enter product title"/>
            </div>
            <div class="mb-3">
              <label class="form-label" for="product-title-input">{{ $t('t-table-products-sort.color') }}</label>
              <input type="text" class="form-control" id="product-title-input" placeholder="Enter product title"/>
            </div>
            <div class="mb-3">
              <label class="form-label" for="product-title-input">{{ $t('t-table-products-sort.size') }}</label>
              <input type="text" class="form-control" id="product-title-input" placeholder="Enter product title"/>
            </div>
            <div class="mb-3">
              <label class="form-label" for="product-title-input">{{ $t('t-table-products-sort.barcode') }}</label>
              <input type="text" class="form-control" id="product-title-input" placeholder="Enter product title"/>
            </div>
            <div class="mb-3">
              <label class="form-label" for="product-title-input">{{ $t('t-table-products-sort.retail-price') }}</label>
              <input type="text" class="form-control" id="product-title-input" placeholder="Enter product title"/>
            </div>
            <div class="mb-3">
              <label class="form-label" for="product-title-input">{{$t('t-table-products-sort.purchase-price') }}</label>
              <input type="text" class="form-control" id="product-title-input" placeholder="Enter product title"/>
            </div>
            <div class="mb-3">
              <label class="form-label" for="product-title-input">{{ $t('t-table-products-sort.supplier') }}</label>
              <input type="text" class="form-control" id="product-title-input" placeholder="Enter product title"/>
            </div>
            <div class="mb-3">
              <label class="form-label" for="product-title-input">{{ $t('t-table-products-sort.remainder') }}</label>
              <input type="text" class="form-control" id="product-title-input" placeholder="Enter product title"/>
            </div>
            <div class="mb-4">
              <h5 class="fs-14 mb-1">{{ $t('t-table-products-sort.img') }}</h5>
        ...
        <div class="text-end mb-3">
          <button type="button" class="btn btn-success w-sm">{{$t('t-action.add') }}</button>
        </div>
      </form>
      <!--      <div class="col-lg-8">-->
      <!--        <form>-->
