...
export default [
...

    {
        path: "/purchases",
        name: "purchases",
        meta: {title: "Purchases", authRequired: true},
        component: () => import("../views/apps/ecommerce/purchases"),
    },

    {
        ...
        component: () => import("../views/apps/ecommerce/market"),
    },
    {
...

    {
        path: "/finance",
        name: "finance",
        meta: {title: "Finance", authRequired: true},
        component: () => import("../views/apps/invoices/list"),
    },
